...
namespace
{
	...
	const char* const WINDOW_TITLE = "Mokongwu Week 7 final project "; 
...
int main(int argc, char* argv[])
{
	...
	// Set up callbacks
	glfwSetCursorPosCallback(g_Window, ViewManager::Mouse_Position_Callback);
	glfwSetScrollCallback(g_Window, ViewManager::Mouse_Scroll_Callback);
	glfwSetKeyCallback(g_Window, ViewManager::Key_Callback);
